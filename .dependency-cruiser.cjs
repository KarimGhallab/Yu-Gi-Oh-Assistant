...
module.exports = {
  forbidden: [
    {
      name: 'no-apps-import',
      severity: 'error',
      comment: 'Apps should not be imported by any other module.',
      from: {
        pathNot: '^apps/'
      },
      to: {
  ...
  options: {
    ...
    exclude: {
      /* path: an array of regular expressions in strings to match against */
      path: ['dist', 'scripts/validate-tsconfig-paths.cjs']
    },
...
// generated: dependency-cruiser@17.2.0 on 2025-11-15T14:02:59.877Z
