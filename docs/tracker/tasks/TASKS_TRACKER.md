...
| 73  | [The API refuses requests from another origin](./73-the-api-refuses-another-origin.md)                                                      | ready-for-agent       | None       | [18](../specs/18-security-hardening.md)                                               |
| 74  | [Card text is data, not instructions, in the model prompts](./74-card-text-is-data-in-the-prompts.md)                                       | ready-for-agent       | None       | [18](../specs/18-security-hardening.md)                                               |
...
constrains its URLs. All three are ready-for-agent and independent.
